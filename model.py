...
class LossNet(nn.Module):
    def __init__(self, feature_sizes=[768, 768, 768, 12], num_channels=[512, 512, 512, 512], interm_dim=128):
        """
        参数需根据backbone模型每层输出特征以及embedding形式对应修改
        """
        ...
        self.GAP4 = nn.AvgPool1d(feature_sizes[3])
